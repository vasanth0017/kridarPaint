...
import { ChevronRight, ShoppingCart, Menu, X, Loader } from "lucide-react";
...
const ProductCatalog = () => {
  ...
  const currentProducts =
    data.find((category) => category.name === selectedCategory)?.products || [];
      ...
      {!isLoading ? (
        <>
          <div className="flex flex-col md:flex-row min-h-screen bg-background">
            ...
            <div className="md:hidden flex justify-between items-center p-4 bg-background shadow-sm">
            ...
            <div className="flex-1 p-4 md:p-8 overflow-y-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
                {currentProducts.map((product: any) => (
                  <div
                    key={product.id}
                    className="rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-xl"
                  >
